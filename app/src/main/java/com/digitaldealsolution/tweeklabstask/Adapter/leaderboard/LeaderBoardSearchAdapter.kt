...
class LeaderBoardSearchAdapter(public var athletesList: ArrayList<AthleteModel>, var sortType: String): RecyclerView.Adapter<LeaderBoardSearchAdapter.ViewHolder>(){
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): LeaderBoardSearchAdapter.ViewHolder {
        val v = LayoutInflater.from(parent.context).inflate(R.layout.card_leaderboard_search, parent, false)
        return ViewHolder(v)
    }
