...
class LeaderboardFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        dialog.setContentView(R.layout.leaderboard_bottomsheet)
        ...
        val controller:LayoutAnimationController = AnimationUtils.loadLayoutAnimation(requireContext(),R.anim.layoutanimation)
        ...
        radioGroup.setOnCheckedChangeListener { group, checkedId ->
            ...
            else if(R.id.release == checkedId){
        ...
        searchTxt.addTextChangedListener(object : TextWatcher{
            ...
            override fun afterTextChanged(s: Editable?) {
                ...
                for( i in athleteModelList){
                    if(i.name.lowercase(Locale.getDefault()).contains(s.toString()
                            .lowercase(Locale.getDefault())) && s.toString() != ""){
                        filterList.add(i)
                    }
                }
